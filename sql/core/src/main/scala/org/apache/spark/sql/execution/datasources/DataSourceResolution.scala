...
import org.apache.spark.sql.catalyst.expressions.logical.Transform
...
case class DataSourceResolution(conf: SQLConf) extends Rule[LogicalPlan] with CastSupport  {
  import org.apache.spark.sql.catalyst.expressions.logical.LogicalExpressions.TransformHelper
